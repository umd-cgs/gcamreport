...
prjname <- "/Users/xiangwenfu/Princeton Dropbox/Xiangwen Fu/Study/postdoc/GCAM/gcam-core/output/gcamreport_trn_urb_test_250828.dat"
...
generate_report(scenarios = scen,  prj_name = prjname,
